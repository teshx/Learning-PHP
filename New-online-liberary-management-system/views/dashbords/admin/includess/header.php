...
<body>
    ...
    <div class="sidebar" id="mySidebar">
        ...
        <a href="./register.php" onclick="toggleSubMenu('categorySubmenu')"><i class="fa fa-user"></i> adduser</a>

        <a href="./manage-register.php" onclick="toggleSubMenu('sizesSubmenu')"><i class="fa fa-edit"></i> Manage-user</a>
        <a href="./borrwing-history.php" onclick="toggleSubMenu('sizesSubmenu')"><i class="fa fa-history"></i> borrowing-History</a>

        <!-- <a href="#productsizes" onclick="toggleSubMenu('productSizesSubmenu')"><i class="fa fa-th-list"></i> Product Sizes</a>
